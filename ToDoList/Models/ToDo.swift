...
//  ToDoList
//
//  Created by Oscar De Villiers on 2026/04/20.
//
...
extension ToDo {
    ...
    static var preview: ModelContainer {
        ...
        // Add mock data
        container.mainContext.insert(ToDo(item: "Create SwiftData Lessons", reminderIsOn: true, dueDate: Date.now + 60*60*24, notes: "Now with iOS 16 & 18", isCompleted: false))
        ...
        container.mainContext.insert(ToDo(item: "Prepare old iPhone for Lily", reminderIsOn: true, dueDate: Date.now + 60*60*12, notes: "Now with iOS 16 & 18", isCompleted: false))
